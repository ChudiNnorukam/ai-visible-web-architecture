...
| `chudi.dev` exposes an agent interface layer. | `https://chudi.dev/blog/webmcp-sveltekit-implementation` | [proof/webmcp-implementation.md](./webmcp-implementation.md) | `surface contract` |
